...
/**
 * Slightly modified version of the AWT Color class
 */
public class Color {
    ...
    /**
     * The color value in the default sRGB {@code ColorSpace} as {@code float}
     * components (no alpha). If {@code null} after object construction, this must
     * be an sRGB color constructed with 8-bit precision, so compute from the
    ...
    /**
     * The color value in the native {@code ColorSpace} as {@code float} components
     * (no alpha). If {@code null} after object construction, this must be an sRGB
     * color constructed with 8-bit precision, so compute from the {@code int} color
     * value.
     *
     * @serial
     * @see    #getRGBColorComponents
    ...
    /**
     * The alpha value as a {@code float} component. If {@code frgbvalue} is
     * {@code null}, this is not valid data, so compute from the {@code int} color
     * value.
     *
     * @serial
     * @see    #getRGBComponents
    ...
    /**
     * Checks the color {@code float} components supplied for validity. Throws an
     * {@code IllegalArgumentException} if the value is out of range.
     *
     * @param r the Red component
     * @param g the Green component
     * @param b the Blue component
     ...
     * components of this {@code Color} to create a brighter version of this
     * {@code Color}. The {@code alpha} value is preserved. Although
     * {@code brighter} and {@code darker} are inverse operations, the results of a
     * series of invocations of these two methods might be inconsistent because of
     * rounding errors.
     *
     * @return a new {@code Color} object that is a brighter version of this
     ...
     * <p>
     * This method applies an arbitrary scale factor to each of the three RGB
     * components of this {@code Color} to create a darker version of this
     * {@code Color}. The {@code alpha} value is preserved. Although
     * {@code brighter} and {@code darker} are inverse operations, the results of a
     * series of invocations of these two methods might be inconsistent because of
     * rounding errors.
     *
     * @return a new {@code Color} object that is a darker version of this
     *         {@code Color} with the same {@code alpha} value.
     ...
     * and is a {@code Color} object that has the same red, green, blue, and alpha
     * values as this object.
     *
     * @param  obj the object to test for equality with this {@code Color}
     ...
     *
     * @param     nm                    a {@code String} that represents an opaque
     *                                  color as a 24-bit integer
     * @return                          the new {@code Color} object.
     * @see                             java.lang.Integer#decode
     * @exception NumberFormatException if the specified string cannot be
     *                                  interpreted as a decimal, octal, or
     *                                  hexadecimal integer.
     * @since                           1.1
     */
     ...
     * which is then converted to a {@code Color} object.
     * <p>
     * If the specified property is not found or cannot be parsed as an integer then
     * the {@code Color} specified by the second argument is returned instead.
     *
     * @param  nm the name of the color property
     * @param  v  the default {@code Color}
     * @return    the {@code Color} converted from the system property, or the
     ...
     * <p>
     * If the specified property is not found or could not be parsed as an integer
     * then the integer value {@code v} is used instead, and is converted to a
     * {@code Color} object.
     *
     * @param  nm the name of the color property
     * @param  v  the default color value, as an integer
     * @return    the {@code Color} converted from the system property or the
     *            {@code Color} converted from the specified integer.
     * @see       java.lang.System#getProperty(java.lang.String)
     * @see       java.lang.Integer#getInteger(java.lang.String)
     * @see       java.awt.Color#Color(int)
     * @since     1.0
     ...
     *                 and brightness (in that order), of the color with the
    ...
    /**
     * Creates a {@code Color} object based on the specified values for the HSB
     * color model.
     * <p>
     * The {@code s} and {@code b} components should be floating-point values
     * between zero and one (numbers in the range 0.0-1.0). The {@code h} component
     * can be any floating-point number. The floor of this number is subtracted from
     * it to create a fraction between 0 and 1. This fractional number is then
     * multiplied by 360 to produce the hue angle in the HSB color model.
     *
     * @param  h the hue component
     * @param  s the saturation of the color
     * @param  b the brightness of the color
     * @return   a {@code Color} object with the specified hue, saturation, and
     *           brightness.
     * @since    1.0
     */
    ...
    /**
     * Returns a {@code float} array containing the color and alpha components of
     * the {@code Color}, as represented in the default sRGB color space. If
     * {@code compArray} is {@code null}, an array of length 4 is created for the
     * return value. Otherwise, {@code compArray} must have length 4 or greater, and
    ...
    /**
     * Returns a {@code float} array containing the color and alpha components of
     * the {@code Color}, in the {@code ColorSpace} of the {@code Color}. If
     * {@code compArray} is {@code null}, an array with length equal to the number
     * of components in the associated {@code ColorSpace} plus one is created for
     * the return value. Otherwise, {@code compArray} must have at least this length
     * and it is filled in with the components and returned.
     *
     * @param  compArray an array that this method fills with the color and alpha
     *                   components of this {@code Color} in its {@code ColorSpace}
     *                   and returns
    ...
    /**
     * Returns a {@code float} array containing only the color components of the
     * {@code Color}, in the {@code ColorSpace} of the {@code Color}. If
     * {@code compArray} is {@code null}, an array with length equal to the number
     * of components in the associated {@code ColorSpace} is created for the return
     * value. Otherwise, {@code compArray} must have at least this length and it is
     * filled in with the components and returned.
     *
     * @param  compArray an array that this method fills with the color components
     *                   of this {@code Color} in its {@code ColorSpace} and returns
