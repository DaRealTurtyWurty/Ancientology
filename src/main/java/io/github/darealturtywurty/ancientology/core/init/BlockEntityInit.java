...
public final class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<JumprasherBlockEntity>> JUMPRASHER = BLOCK_ENTITIES.register(
            BlockInit.JUMPRASHER.getId().getNamespace(),
            () -> BlockEntityType.Builder.of(JumprasherBlockEntity::new, BlockInit.JUMPRASHER.get()).build(null));
